...
const abnormalConfig = {
  ...
  inBox: {
    ...
    buttons: [
      {key: 'setToRead_Abnormal', title: '设为已读', bsStyle: 'primary'},
      {key: 'delete_Abnormal', title: '删除'}
    ],
    tableCols: [
  ...
  outBox: {
    ...
    buttons: [
      {key: 'sendInfo_Abnormal', title: '发送消息', bsStyle: 'primary'}
    ],
    tableCols: [
