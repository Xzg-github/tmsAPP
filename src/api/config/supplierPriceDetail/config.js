...
const filters = [
  {key: 'supplierPriceCode', title: '系统编号', type: 'text'},
...
const buttons = [
  {key: 'add', title: '新增', bsStyle: 'primary', sign: 'supplierPriceDetail_add'},
  {key: 'copy', title: '复制新增', sign: 'supplierPriceDetail_copy'},
  {key: 'edit', title: '编辑', sign: 'supplierPriceDetail_edit'},
  {key: 'batchEdit', title: '批量修改', sign: 'supplierPriceDetail_batchEdit'},
  {key: 'delete', title: '删除', confirm: '是否确定删除所选数据？', sign: 'supplierPriceDetail_delete'},
  {key: 'enable', title: '启用', sign: 'supplierPriceDetail_enable'},
  {key: 'disable', title: '禁用', sign: 'supplierPriceDetail_disable'},
  {key: 'import', title: '导入', sign: 'supplierPriceDetail_import'},
  {key: 'export', title: '导出', sign: 'supplierPriceDetail_export'},
  {key: 'config', title: '配置字段', sign: 'supplierPriceDetail_config'},
];

const tableCols = [
  {key: 'supplierPriceCode', title: '系统编号'},
...
const tabs = [
  {key: 'index', title: '供应商运费列表', close: false},
  {key: 'extraCharge', title: '供应商附加费列表', close: false}
];
