...
const tableCols = [
  ...
  {key: 'carArea', title: '车辆归属区域',dictionary:'car_area'},
...
const controls = [
  ...
  {key: 'driverId', title: '司机标识',type:'search',required:true,searchUrl:DRIVER},
  {key: 'carArea', title: '车辆归属区域',type:'select',dictionary:'car_area',showAdd:true},
  {key: 'institutionId', title: '归属机构',type:'search',searchType:'institution'},
...
const config = {
  ...
  dictionary: ['enabled_type','zero_one_type','gps_equipment_brand','fuel_type','car_area']
};
