...
const payColsEdit = [
  ...
  {key: 'amount', title: '金额', type: 'number', props: {real: true, precision: 2}},
  {key: 'currency', title: '币种', type: 'select', dictionary: 'currency'},
  {key: 'exchangeRate', title: '汇率', type: 'number', props: {real: true, precision: 2}},
  ...
  {key: 'netAmount', title: '净价', type: 'number', props: {real: true, precision: 2}},
  {key: 'remark', title: '备注', type: 'text'},
