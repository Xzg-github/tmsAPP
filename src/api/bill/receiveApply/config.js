...
const invoiceInfoConfig = {
  cols: [
    ...
    {key: 'netAmount', title: '净额', type: 'number', props: {real: true, precision: 2},
      otherProps: {disabled: true}},
    {key: 'exchangeCurrency', title: '币种', type: 'textarea',
      otherProps: {disabled: true}},
      {key: 'itemAmount', title: '金额', type: 'textarea',
        otherProps: {disabled: true}},
    {key: 'currency', title: '开票币种', type: 'text',
      otherProps: {disabled: true}},
    {key: 'exchangeAmount', title: '开票金额', type: 'textarea',
