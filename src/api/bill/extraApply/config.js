...
const payCols = [
  ...
  {key: 'number', title: '数量', type: 'number', required: true},
  {key: 'amount', title: '金额', type: 'readonly'},
  {key: 'currency', title: '币种', type: 'select', dictionary: 'currency', required: true},
...
const receiveCols = [
  {key: 'checked', title: '', type: 'checkbox'},
  {key: 'index', title: '序号', type: 'index'},
  {key: 'balanceId', title: '结算单位', type: 'search', searchType: 'customer', required: true},
  {key: 'chargeItemId', title: '费用名称', type: 'search', required: true},
  {key: 'chargeUnit', title: '计量单位', type: 'select', dictionary: name.CHARGE_UNIT, required: true},
  {key: 'price', title: '单价', type: 'number', props: {real: true, precision: 2}, required: true},
  {key: 'number', title: '数量', type: 'number', props: {real: true, precision: 4}, required: true},
