...
const config = {
  ...
  subTabs: [
    {key: 'order', title:'已下单', status: 'statusCustomerOrderCompleted'},
    {key: 'dispatch', title:'已派发', status: 'statusCsSendCompleted'},
    {key: 'confirm', title:'派车已确认', status: 'statusVehicleCompletedCheck'},
    {key: 'transport', title:'运输已开始', status: 'statusInTransport'},
    {key: 'complete', title:'已完成', status: 'statusCompleted'},
    {key: 'sign', title:'已签收', status: 'statusSignCompleted'},
    {key: 'bill', title:'已结算', status: 'statusSettlementCompleted'},
    {key: 'cancel', title:'已取消', status: 'statusCancelCompleted'},
  ],
  filters,
  tableCols,
