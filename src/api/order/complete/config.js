...
const filters = [
  ...
  {key: 'statusType', title: '运单状态', type: 'select', dictionary: 'transport_order'},
  {key: 'orderType', title: '任务状态', type: 'select', dictionary: 'order_type'},
];
...
const config = {
  ...
  paginationConfig,
  searchConfig,
  urlExport: '/tms-service-zmm/transport_order/handled_task_list/search', //后端查询导出api配置
