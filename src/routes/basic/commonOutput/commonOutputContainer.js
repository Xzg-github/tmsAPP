...
const URL_CONFIG = '/api/basic/commonOutput/config';
...
const initActionCreator = () => async (dispatch) => {
  ...
  let data = await fetchDictionary(config.result.names);
  ...
  payload.buttons = dealActions(payload.buttons, 'commonOutput');
  payload.status = 'page';
