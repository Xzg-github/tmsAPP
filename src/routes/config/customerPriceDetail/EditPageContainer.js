...
const URL_DELETE = '/api/config/customerPriceDetail/extraChargeDelete';
const URL_ABLE = '/api/config/customerPriceDetail/extraChargeAble';
const URL_ADD = '/api/config/customerPriceDetail/extraChargeAdd';
const URL_EDIT = '/api/config/customerPriceDetail/extraChargeEdit';
const URL_BATCHEDIT = '/api/config/customerPriceDetail/extraChargeBatchEdit';
