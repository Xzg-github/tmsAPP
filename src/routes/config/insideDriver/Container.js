...
const URL_CONFIG = '/api/config/insideDriver/config';
const URL_LIST = '/api/config/insideDriver/list';
...
const importActionCreator = () => {
  return showImportDialog('driver_info_import');
};
...
const exportSearchActionCreator = (subKey) => (dispatch, getState) =>{
  ...
  return commonExport(tableCols, '/archiver-service/driver_info/list/search', searchData);
};
