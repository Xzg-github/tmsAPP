...
const STATE_PATH = ['message', 'sendMessageByShortMes'];
const URL_CONFIG = '/api/message/sendMessageByShortMes/config';
const URL_LIST = '/api/message/sendMessageByShortMes/list';
const URL_DETAIL = '/api/message/sendMessageByShortMes/detail';
...
export const buildSendMessageByShortMesState = async () =>{
  ...
  config = data.result;
  config.index.tableCols = initTableCols('sendMessageByShortMes', config.index.tableCols);
