...
const STATE_PATH = ['receiveChange', 'edit'];
const STATE_PARENT_PATH = ['receiveChange'];
...
const URL_TRANSINFO = '/api/bill/receive_change/transportInfo';
const URL_ADDSAVE = '/api/bill/receive_change/addSave';
const URL_EDITSAVE = '/api/bill/receive_change/editSave';
const URL_COMMIT =  '/api/bill/receive_change/commit';
const URL_AUDIT = '/api/bill/receive_change/audit';
const URL_REJECT = '/api/bill/receive_change/reject';
const URL_CURRENCY = '/api/bill/receive_change/mainCurrency';
const URL_TAX = '/api/bill/receive_change/tax';
const URL_NET = '/api/bill/receive_change/net';
