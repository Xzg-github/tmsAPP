...
const URL_JOIN = '/api/bill/receive_monthly_bill/joinSettlement';//应收月帐单加入对账明细
const URL_DEL = '/api/bill/receive_monthly_bill/del';//删除明细
...
const URL_LIST = '/api/bill/receive_monthly_bill/monthId';//根据月帐单标识及应收结算单标识返回列表信息
